...
\setlist[description]{leftmargin=1em,labelindent=--0.2em}
...
\begin{table}[ht]
\caption{Number (percentage) of the negative subset, positive subset, and all of the {\textit{COMT}}\den correlated genes in each brain area having at least one instance of the TATA8 motif$^a$ in the region from -250 to +150 nucleotides relative to the transcription start site TSS (adjacent to +1)} 
\centering
\begin{tabular}{l r c r c r c}
  \hline
 & Negative & Number of Genes & Positive & Number of Genes & All {\textit{COMT}} Genes & Number of Genes \\ 
  \hline
Prefrontal Cortex & 10 (6.0)  & 168 & 21 (6.6)  & 319 & 1192 (7.5)  & 15998 \\ 
  Cerebellum & 8 (6.9)  & 116 & 20 (5.3)  & 375 & 1176 (7.3)  & 16008 \\ 
  Temporal Cortex & 4 (4.3)  & 94 & 27 (6.7)  & 401 & 1176 (7.4)  & 15967 \\ 
  Pons & 1 (1.5)  & 68 & 25 (5.9)  & 423 & 1179 (7.4)  & 15950 \\ 
   \hline
\end{tabular}
...
{\footnotesize {
\vspace{-1em}
\hspace{-2.0em} -30 TSS locus underlined\\
\vspace{-1em}
\begin{description}
	\item[a.] TATA8 consensus motif {\underline{T}}ATAWAWN: e.g.,{\underline{T}}ATAAATC
\end{description}
}}
\end{landscape}
\end{document}