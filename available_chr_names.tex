...
% Mon Feb 19 16:48:18 2018
\begin{table}[ht]
\centering
\begin{tabular}{rrrrr}
  \toprule
 & \begin{sideways} Prefrontal Cortex \end{sideways} & \begin{sideways} Cerebellum \end{sideways} & \begin{sideways} Temporal Cerebral Wall \end{sideways} & \begin{sideways} Pons \end{sideways} \\ 
  \midrule
Total Probes & 20000 & 20000 & 20000 & 20000 \\ 
  Probes with Chromosome Name & 19573 & 19568 & 19574 & 19581 \\ 
  Probes with Start Position & 19538 & 19534 & 19540 & 19546 \\ 
   \bottomrule
\end{tabular}
\caption{Probes with Chromosome Names or Start Positions} 
\end{table}
\end{document}