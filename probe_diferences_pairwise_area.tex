...
% Mon Feb 19 19:50:32 2018
\begin{table}[ht]
\centering
\begin{tabular}{rr}
  \hline
 & Number of Illumina Probe Differences \\ 
  \hline
Prefrontal Cortex vs. Ceberebellum & 2016 \\ 
  Prefrontal Cortex vs. Temporal Cerebral Wall & 1784 \\ 
  Prefrontal Cortex vs. Pons & 1998 \\ 
  Cerebellum vs. Temporal Cerebral Wall & 1946 \\ 
  Cerebellum vs. Pons & 1847 \\ 
  Temporal Cerebral Wall vs. Pons & 1909 \\ 
   \hline
\end{tabular}
\caption{Number of Illumina Probe Differences Between Brain Areas:
 Base of 20,000 Probes per Area} 
\end{table}
\end{document}