...
\begin{TableNotes}
{\footnotesize {
\item [a] transcription start position
\item [b] gene symbols beginning with {\textit {LOC}}; example: {\textit {LOC730412}}
\item [c] After preprocessing there were no probes with gene symbols {\textit {LOCxx}} and with unknown chromosome names. 
}}
\end{TableNotes}
{\small {
\begin{longtable}{l p{1.5in} r r r r}
\caption{Numbers of probes in the original data (Original) and after preprocessing (Processed) having the characteristics shown under the Measure column.} \\
\toprule
\multicolumn{1}{l}{\bfseries Measure} & &\multicolumn{1}{c}{\bfseries prefrontal}&\multicolumn{1}{c}{\bfseries cerebellum}&\multicolumn{1}{c}{\bfseries temporal}&\multicolumn{1}{c}{\bfseries pons} \\
\midrule
\endfirsthead\caption[]{\em (Number of Genes in Common Continued)} \\
\midrule
\multicolumn{1}{l}{\bfseries Measure} & &\multicolumn{1}{r}{\bfseries prefrontal}&\multicolumn{1}{r}{\bfseries cerebellum}&\multicolumn{1}{r}{\bfseries temporal}&\multicolumn{1}{r}{\bfseries pons} \\
\midrule
\endhead
\midrule
\endfoot
