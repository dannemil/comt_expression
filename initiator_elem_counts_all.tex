...
\begin{table}[ht]
\caption{Number (proportion) of all {\textit {COMT}}\den correlated genes in each brain area having three different consensus intiator element (Inr) sequences on either DNA strand} 
\centering
\begin{tabular}{l c c c c}
  \hline
 & Inr1$^a$ & Inr2$^b$  & Inr3$^c$  & Number of Strands \\ 
  \hline
Prefrontal Cortex & 701 (.022) & 447 (.014) & 27312 (.854) & 31996 \\ 
  Cerebellum & 717 (.022) & 438 (.014) & 27336 (.854) & 32016 \\ 
  Temporal Cortex & 714 (.022) & 441 (.014) & 27250 (.853) & 31934 \\ 
  Pons & 718 (.023) & 449 (.014) & 27247 (.854) & 31900 \\ 
   \hline
\end{tabular}
\end{table}
}}
{\footnotesize {
\vspace{-1em}
\hspace{7.0em} TSS +1 locus underlined\\
\vspace{-1em}
\begin{description}
