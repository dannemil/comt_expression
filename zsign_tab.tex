...
\midrule
%			  	&		  					&		&		&		&			&				&		&		&		\\
		    				& below	  				&		& \cellcolor{kugray5}4141\footnote[1]{The cells shaded gray represent tissue {\textit {non\den specific}} expression regulation.}	&		& \cellcolor{riceblue}446\footnote[2]{Blue: Pons\den specific regulation}		&				& \cellcolor{lightgreen}708\footnote[3]{Green: Cerebellum\den specific regulation}	&		& 602	\\
below		    				& {\bfseries {Temporal Cortex}} 	  	&		&		&		&			&				&		&		&		\\   
		    				& above	  				&		& \cellcolor{pink}249\footnote[4]{Red: Temporal Cortex\den specific regulation}	&		& 78			&				& 66		&		& \cellcolor{purple}154	\\
{\bfseries {Prefrontal Cortex}} 		     	&	 			 	&		&		&		&			&				&		&		&		\\
						& below	  				&		& \cellcolor{purple}439\footnote[5]{Purple: Prefrontal Cortex\den specific regulation}	&		& 69			&				& 87		&		& \cellcolor{pink}176	\\
above		    				& {\bfseries {Temporal Cortex}} 	 	&		&		&		&			&				&		&		&		\\ 
						& above  				&		& 605	&		& \cellcolor{lightgreen}443		&				& \cellcolor{riceblue}255	&		& \cellcolor{kugray5}2186	\\
