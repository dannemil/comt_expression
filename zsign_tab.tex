...
\definecolor{lightgreen}{rgb}{0.7,0.9,0.4}
\definecolor{myblue}{rgb}{0.3,0.3,0.8}
\definecolor{kugray5}{RGB}{224,224,224}
\definecolor{lightgray}{gray}{0.9}
\definecolor{pink}{rgb}{1.0,0.7,0.6}
\definecolor{purple}{rgb}{0.9,0.7,1.0}
...
\begin{minipage}[t][4cm][c]{6in}
%\noindent
%\arraystretch{0.8}
{\small {
\begin{longtable}{c c c c c c c c c c}
\caption{{\textit {COMT}}\den correlation relative to average {\textit {COMT}}\den correlation within a brain region. } \\ 
\toprule
		    		&	  						&		&    		& below		&			& {\bfseries {Cerebellum}}		&    		& above		&		\\\cline{4-6}\cline{8-10}		
		    		&	  						&		& below		& {\bfseries {Pons}}	& above			&				& below		& {\bfseries {Pons}}	& above		\\
\midrule
%			  	&		  					&		&		&		&			&				&		&		&		\\
		    				& below	  				&		& \cellcolor{kugray5}5051\footnote[1]{The cells shaded gray represent tissue {\textit {non\den specific}} expression regulation.}	&		& \cellcolor{riceblue}531\footnote[2]{Blue: Pons\den specific regulation}		&				& \cellcolor{lightgreen}874\footnote[3]{Green: Cerebellum\den specific regulation}	&		& 737	\\
below		    				& {\bfseries {Temporal Cortex}} 	  	&		&		&		&			&				&		&		&		\\   
		    				& above	  				&		& \cellcolor{pink}316\footnote[4]{Red: Temporal Cortex\den specific regulation}	&		& 96			&				& 93		&		& \cellcolor{purple}189	\\
{\bfseries {Prefrontal Cortex}} 		     	&	 			 	&		&		&		&			&				&		&		&		\\
						& below	  				&		& \cellcolor{purple}540\footnote[5]{Purple: Prefrontal Cortex\den specific regulation}	&		& 80			&				& 101		&		& \cellcolor{pink}212	\\
above		    				& {\bfseries {Temporal Cortex}} 	 	&		&		&		&			&				&		&		&		\\ 
						& above  				&		& 738	&		& \cellcolor{lightgreen}521	&				& \cellcolor{riceblue}311	&		& \cellcolor{kugray5}2663	\\
