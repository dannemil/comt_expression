...
<<include=FALSE, echo=FALSE, results=tex>>=
############# Do the selection of the top correlations here based on the procedure that
############# takes into account the number of probes per chromosome and chromosome length

############# Do it here rather than earlier because at this point the missing Chr names 
############# and start positions have been filled in as completely as possible

##### (1) ######## Make the selection independently of probes per chromosome 
