...
\begin{table}[ht]
\caption{Number (proportion) of the negative subset of the 500 most highly {\textit {COMT}}\den correlated genes in each brain area having three different consensus intiator element (Inr) sequences on either DNA strand} 
\centering
\begin{tabular}{l c c c c}
  \hline
 & Inr1$^a$ & Inr2$^b$  & Inr3$^c$  & Number of Strands \\ 
  \hline
Prefrontal Cortex & 5 (.015) & 3 (.009) & 304 (.905) & 336 \\ 
  Cerebellum & 5 (.022) & 5 (.022) & 186 (.802) & 232 \\ 
  Temporal Cortex & 5 (.027) & 2 (.011) & 160 (.851) & 188 \\ 
  Pons & 4 (.029) & 1 (.007) & 120 (.882) & 136 \\ 
   \hline
\end{tabular}
\end{table}
}}
{\footnotesize {
\vspace{-1em}
\hspace{8.0em} TSS +1 locus underlined\\
\vspace{-1em}
\begin{description}
	\item[a.] Inr: BBC{\underline{A}}BW
	\item[b.] Inr: YY{\underline{A}}NWYY
	\item[c.] Inr: Y{\underline{R}}
\end{description}
}}
\end{landscape}
\end{document}