...
proms.pos.p.rc <- list()
proms.neg.p.rc <- list()
proms.all.p.rc <- list()    # all available COMT project genes with full variable information

proms.pos.p.rc <- lapply(proms.pos.indx.s[ib], function(x,ib)  reverseComplement(promoter_seq[c(na.omit(x)),]), ib)
proms.neg.p.rc <- lapply(proms.neg.indx.s[ib], function(x,ib)  reverseComplement(promoter_seq[c(na.omit(x)),]), ib)
proms.all.p.rc <- lapply(proms.all.indx.s[ib], function(x,ib)  reverseComplement(promoter_seq[c(na.omit(x)),]), ib)
...
proms.pos.m.rc <- lapply(proms.pos.indx.s[ib], function(x,ib)  reverseComplement(promoter_seq.minus[c(na.omit(x)),]), ib)
proms.neg.m.rc <- lapply(proms.neg.indx.s[ib], function(x,ib)  reverseComplement(promoter_seq.minus[c(na.omit(x)),]), ib)
proms.all.m.rc <- lapply(proms.all.indx.s[ib], function(x,ib)  reverseComplement(promoter_seq.minus[c(na.omit(x)),]), ib)

@

<<revcomp>>=
# Proceed from here by just analysing the reversecomplemented sequences, not both
proms.pos.p <- proms.pos.p.rc
proms.neg.p <- proms.neg.p.rc
proms.all.p <- proms.all.p.r 

proms.pos.m <- proms.pos.m.rc
proms.neg.m <- proms.neg.m.rc
proms.all.m <- proms.all.m.rc 
...
write.fasta(sequences=str_split(promoter.Full$prom.Seq[[1]],''),names=promoter.Full$header[[1]],file.out='fasta_500_promoter_seq_pf_final_REVCOMP.fa',nbchar=1600)

write.fasta(sequences=str_split(promoter.Full$prom.Seq[[2]],''),names=promoter.Full$header[[2]],file.out='fasta_500_promoter_seq_cb_final_REVCOMP.fa',nbchar=1600)

write.fasta(sequences=str_split(promoter.Full$prom.Seq[[3]],''),names=promoter.Full$header[[3]],file.out='fasta_500_promoter_seq_tm_final_REVCOMP.fa',nbchar=1600)

write.fasta(sequences=str_split(promoter.Full$prom.Seq[[4]],''),names=promoter.Full$header[[4]],file.out='fasta_500_promoter_seq_po_final_REVCOMP.fa',nbchar=1600)
...
write.fasta(sequences=str_split(fasta.500.pos$seq[[1]],''),names=fasta.500.pos$header[[1]],file.out='fasta_500_promoter_seq_pf_pos_REVCOMP.fa',nbchar=1600)
write.fasta(sequences=str_split(fasta.500.neg$seq[[1]],''),names=fasta.500.neg$header[[1]],file.out='fasta_500_promoter_seq_pf_neg_REVCOMP.fa',nbchar=1600)

write.fasta(sequences=str_split(fasta.500.pos$seq[[2]],''),names=fasta.500.pos$header[[2]],file.out='fasta_500_promoter_seq_cb_pos_REVCOMP.fa',nbchar=1600)
write.fasta(sequences=str_split(fasta.500.neg$seq[[2]],''),names=fasta.500.neg$header[[2]],file.out='fasta_500_promoter_seq_cb_neg_REVCOMP.fa',nbchar=1600)

write.fasta(sequences=str_split(fasta.500.pos$seq[[3]],''),names=fasta.500.pos$header[[3]],file.out='fasta_500_promoter_seq_tm_pos_REVCOMP.fa',nbchar=1600)
write.fasta(sequences=str_split(fasta.500.neg$seq[[3]],''),names=fasta.500.neg$header[[3]],file.out='fasta_500_promoter_seq_tm_neg_REVCOMP.fa',nbchar=1600)

write.fasta(sequences=str_split(fasta.500.pos$seq[[4]],''),names=fasta.500.pos$header[[4]],file.out='fasta_500_promoter_seq_po_pos_REVCOMP.fa',nbchar=1600)
write.fasta(sequences=str_split(fasta.500.neg$seq[[4]],''),names=fasta.500.neg$header[[4]],file.out='fasta_500_promoter_seq_po_neg_REVCOMP.fa',nbchar=1600)
