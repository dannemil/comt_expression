...
\setlongtables\begin{longtable}{lrrcrr}\caption{Number of Probes in Common Across Brain Areas with the 50 or 200 Most Strongly Positively and Negatively COMT-Correlated Probes in Prefrontal Cortex} \tabularnewline
\toprule
\multicolumn{1}{l}{\bfseries }&\multicolumn{2}{c}{\bfseries 50}&\multicolumn{1}{c}{\bfseries }&\multicolumn{2}{c}{\bfseries 200}\tabularnewline
\cline{2-3} \cline{5-6}
\multicolumn{1}{l}{\bfseries }&\multicolumn{1}{c}{\bfseries pos}&\multicolumn{1}{c}{\bfseries neg}&\multicolumn{1}{c}{\bfseries }&\multicolumn{1}{c}{\bfseries pos}&\multicolumn{1}{c}{\bfseries neg}\tabularnewline
\midrule
\endfirsthead\caption[]{\em (Number of Probes in Common Continued)} \tabularnewline
\midrule
\multicolumn{1}{l}{\bfseries }&\multicolumn{2}{c}{\bfseries 50}&\multicolumn{1}{c}{\bfseries }&\multicolumn{2}{c}{\bfseries 200}\tabularnewline
\cline{2-3} \cline{5-6}
\multicolumn{1}{l}{\bfseries }&\multicolumn{1}{c}{\bfseries pos}&\multicolumn{1}{c}{\bfseries neg}&\multicolumn{1}{c}{\bfseries }&\multicolumn{1}{c}{\bfseries pos}&\multicolumn{1}{c}{\bfseries neg}\tabularnewline
...
\midrule
\endfoot
\label{tab:numsharedprobes}
Cerebellum&$50$&$48$&&$197$&$192$\tabularnewline
Temporal Cerebral Wall&$50$&$50$&&$200$&$199$\tabularnewline
Pons&$48$&$49$&&$196$&$191$\tabularnewline
\bottomrule
\end{longtable}
