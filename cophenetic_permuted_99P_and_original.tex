...
{\small {
\begin{table}[ht]
\caption{Cophenetic correlations: 99th Percentiles of randomly permuted promoter loci and the cophenetic correlations for the original data for the most strongly positively and negatively {\textit {COMT}}\den correlated gene subsets.} 
\centering
\begin{tabular}{l r r r r}
& \multicolumn{2}{c}{Positive} & \multicolumn{2}{c}{Negative} \\
  \hline
 & Permuted & Original & Permuted & Original \\ 
  \hline
Prefrontal 		& 0.50 	& 0.64 	& 0.46	& 0.53 \\ 
  Cerebellum 	& 0.49 	& 0.66 	& 0.46	& 0.50 \\ 
  Temporal 	& 0.48 	& 0.67 	& 0.45	& 0.51 \\ 
  Pons 		& 0.48 	& 0.70 	& 0.47	& 0.47 \\ 
   \hline
\end{tabular}
\end{table}
}}
...
Prefrontal 		& 0.50 	& 0.46 	& 0.64 	& 0.53 \\ 
  Cerebellum 	& 0.49 	& 0.46 	& 0.66 	& 0.50 \\ 
  Temporal 	& 0.48 	& 0.45 	& 0.67 	& 0.51 \\ 
  Pons 		& 0.48 	& 0.47 	& 0.70 	& 0.47 \\ 
