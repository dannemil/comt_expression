...
\begin{table}[ht]
\caption{ FG: positive COMT correlations, BG: negative COMT correlations, Prefrontal motifs }
\centering
\begin{tabular}{|l|l|l|l|l|l|}
\hline
Consensus&scores&ratio&fg.frac&bg.frac&logo\\
\hline
NNDSCCAGGVNN &6.4&1.7&0.95&0.82&\includegraphics[height=1in, width=3in]{./posnegPF-1.pdf}\\
\hline
NNBCCTGCCNBNN &6.0&1.8&0.85&0.64&\includegraphics[height=1in, width=3in]{./posnegPF-2.pdf}\\
\hline
CNCCAGGANN &4.7&2.0&0.55&0.36&\includegraphics[height=1in, width=3in]{./posnegPF-3.pdf}\\
\hline
\end{tabular}
\end{table}
}}
