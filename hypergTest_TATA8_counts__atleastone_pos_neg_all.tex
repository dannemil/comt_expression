...
\setlist[description]{leftmargin=1em,labelindent=-5.0em}
...
\caption{Number (percentage) of the negative subset, positive subset, and all of the {\textit{COMT}}\den correlated genes in each brain area having at least one instance of the TATA8 motif$^a$ in the region from -250 to +150 nucleotides relative to the transcription start site TSS (adjacent to +1). The p-values are derived from hypergeometric tests on the negative and positive subsets given the statistics for all the genes shown in the same rows of last two columns.} 
\centering
\begin{tabular}{l r c c r c c c c}
  \hline
 & Negative & Number of Genes & p-value & Positive & Number of Genes & p-value & All {\textit{COMT}} Genes & Number of Genes \\ 
  \hline
Prefrontal Cortex & 10 (6.0)  & 168 & 0.285 & 21 (6.6)  & 319 & 0.321 & 1192 (7.5)  & 15998 \\ 
  Cerebellum & 8 (6.9)  & 116 & 0.517 & 20 (5.3)  & 375 & 0.074 & 1176 (7.3)  & 16008 \\ 
  Temporal Cortex & 4 (4.3)  & 94 & 0.169 & 27 (6.7)  & 401 & 0.355 & 1176 (7.4)  & 15967 \\ 
  Pons & 1 (1.5)  & 68 & 0.034 & 25 (5.9)  & 423 & 0.137 & 1179 (7.4)  & 15950 \\ 
   \hline
\end{tabular}
\end{adjustwidth}
\end{table}
...
\vspace{-1em}
\begin{description}
	\item[a.] TATA8 consensus motif {\underline{T}}ATAWAWN: e.g.,{\underline{T}}ATAAATC (-30 TSS locus underlined)
\end{description}
}}
\end{landscape}}
\end{document}