## Changing the corrplot function to allow alteration of the title font size.
...
corrplot2 <- function (corr, method = c("circle", "square", "ellipse", "number", 
                       ...
                       cl.pos = NULL, cl.lim = NULL, cl.length = NULL, cl.cex = 0.8, cex.main=0.3,
                       ...
                       uppCI.mat = NULL, number.cex = 0.75) 
{
     library(corrplot)
