...
\begin{table}[ht]
\centering
\caption{{\small{Gene symbols in original, unprocessed data (columns 1 to 3) and in the preprocessed data (columns 5 to 7) {\textit {shared}} by pairs of brain areas. The two {\textit {Unique}} columns show the number of unique genes measured in each brain area (row). The reductions from the number of unique genes in the original to the preprocessed data result from the elimination of some of the probes that were used to measure gene expression.}}}
\begin{tabular}{lccccccccc}
& \multicolumn{4}{c}{\bfseries{Original}}  & & \multicolumn{4}{c}{\bfseries{Preprocessed}}\\ \cline{2-5}\cline{7-10}
%  \hline
 & cerebellum & temporal & pons & Unique & & cerebellum & temporal & pons & Unique \\ 
  \hline
prefrontal & 15285 & 15406 & 15233 & 16676 & & 15273 & 15387 & 15214 & 16667 \\ 
  cerebellum &  & 15300 & 15339 & 16687 & &  & 15286 & 15327 & 16683 \\ 
  temporal &  &  & 15267 & 16643 & &  &  & 15248 & 16634 \\ 
  pons &  &  &  & 16643 & &  &  &  & 16634 \\ 
   \hline
\end{tabular}
%\end{table}
...
%\begin{table}[ht]
\centering
\caption{{\small{Gene symbols in original, unprocessed data (columns 1 to 3) and in the preprocessed data (columns 5 to 7) {\textit {not shared}} by pairs of brain areas. The two {\textit {Unique}} columns show the number of unique genes measured in each brain area (row). The reductions from the number of unique genes in the original to the preprocessed data result from the elimination of some of the probes that were used to measure gene expression.}}}
\begin{tabular}{lccccccccc}
& \multicolumn{4}{c}{\bfseries{Original}}  & & \multicolumn{4}{c}{\bfseries{Preprocessed}}\\ \cline{2-5}\cline{7-10}
%  \hline
 & cerebellum & temporal & pons & Unique & & cerebellum & temporal & pons & Unique \\ 
  \hline
prefrontal & 1391 & 1270 & 1443 & 16676 & & 1394 & 1280 & 1453 & 16667 \\ 
  cerebellum &  & 1387 & 1348 & 16687 & &  & 1397 & 1356 & 16683 \\ 
  temporal &  &  & 1376 & 16643 & &  &  & 1386 & 16634 \\ 
  pons &  &  &  & 16643 & &  &  &  & 16634 \\ 
   \hline
\end{tabular}
\end{table}
