...
\caption{Number of positively COMT-correlated genes in the full sample (gene as unit of analysis) (Column 1), in the 500 most strongly correlated (ranked by p-values) (Column 3), and in the genes among the top 500 only found in the corresponding brain area but not among the top 500 genes in any of the other three areas (Column 5).} \tabularnewline
\toprule
\multicolumn{1}{l}{\bfseries }&\multicolumn{1}{r}{\bfseries \rotatebox{60}{Pos. r full sample}}&\multicolumn{1}{r}{\bfseries \rotatebox{60}{Full Sample}}&\multicolumn{1}{r}{\bfseries \rotatebox{60}{Pos. r top 500 genes}}&\multicolumn{1}{r}{\bfseries \rotatebox{60}{Top 500 genes}}&\multicolumn{1}{r}{\bfseries \rotatebox{60}{Pos. r unique}}&\multicolumn{1}{r}{\bfseries \rotatebox{60}{Unique genes}}\tabularnewline
\midrule
\endfirsthead\caption[]{\em (Numbers of Positively Correlated Genes Continued)} \tabularnewline
\midrule
\multicolumn{1}{l}{\bfseries }&\multicolumn{1}{r}{\bfseries Pos. r full sample}&\multicolumn{1}{r}{\bfseries Full Sample}&\multicolumn{1}{r}{\bfseries Pos. r top 500 genes}&\multicolumn{1}{r}{\bfseries Top 500 genes}&\multicolumn{1}{r}{\bfseries Pos. r unique}&\multicolumn{1}{r}{\bfseries Unique genes}\tabularnewline
\midrule
\endhead
\midrule
\endfoot
\label{tab:num.pos.genes}
Prefrontal&$6329$&$16670$&$330$&$501$&$ 75$&$199$\tabularnewline
Cerebellum&$6158$&$16685$&$382$&$501$&$144$&$236$\tabularnewline
Temporal&$5761$&$16636$&$407$&$501$&$149$&$209$\tabularnewline
Pons&$6600$&$16616$&$433$&$501$&$190$&$235$\tabularnewline
\bottomrule
\end{longtable}
}}
\end{landscape}
